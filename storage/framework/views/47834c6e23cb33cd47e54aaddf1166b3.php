...
<?php $__env->startSection('content'); ?>
    ...
    <div class="product-details">
        ...
        <?php if($complementaryProducts->count() > 0): ?>
                        ...
                        <article class="product-card">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-meta">
                                    <span class="category">
                                        <i class="bi bi-tag-fill"></i> <?php echo e($compProduct->category->name ?? 'Uncategorized'); ?>
        ...
        <?php if(!empty($aiRecommendations) && count($aiRecommendations) > 0): ?>
            <section class="related-products category-related-products" id="ai-related-section">
                <h2 class="related-title"><?php echo e($hasOrderHistory ? 'Recommended Products' : 'You may also like'); ?></h2>
                <div class="products-grid ai-products-grid">
                    <?php $__currentLoopData = $aiRecommendations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <?php if($aiProduct): ?>
                            <?php echo $__env->make('partials.ai-product-card', [
                                'product' => $aiProduct,
                                'showAiBadge' => false,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HIDAYA NURU\hidaya_fyp\resources\views/shop/show.blade.php ENDPATH**/ ?>