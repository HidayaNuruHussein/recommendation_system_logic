    ...
    <nav class="navbar navbar-expand-lg header-navbar py-0">
        <div class="container-fluid header-shell">
            <a href="<?php echo e(route('shop')); ?>" class="navbar-brand logo-container me-0">
                ...
                <div class="logo-text">
                    <span class="school-name"><?php echo e($headerSettings['header_school_name'] ?? 'electronicsStore'); ?></span>
                    <span class="school-subtitle"><?php echo e($headerSettings['header_school_subtitle'] ?? 'Cute .Fun . Safe for use'); ?></span>
                </div>
            </a>
...
<?php /**PATH C:\xampp\htdocs\recommendation_system_logic\resources\views/components/header.blade.php ENDPATH**/ ?>